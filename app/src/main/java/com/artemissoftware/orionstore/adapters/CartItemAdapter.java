...
import com.artemissoftware.orionstore.databinding.CartItemBinding;
import com.artemissoftware.orionstore.models.CartItem;
import com.artemissoftware.orionstore.models.CartItemViewModel;
...
public class CartItemAdapter extends RecyclerView.Adapter<CartItemAdapter.BindingHolder>{
    ...
    public BindingHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        CartItemBinding binding = DataBindingUtil.inflate(LayoutInflater.from(mContext), R.layout.cart_item, parent, false);
